...
| 📊 **Structured report** | One click turns the finished review into a self-contained HTML report: `00 TL;DR → 01 개념 → 02 배경 → 03 방법론 → 04 실험 → 05 한계 → 06 후속 연구`, with key figures, result bars, an ⚠️/🔍 limitation split and web-searched follow-up papers. |
